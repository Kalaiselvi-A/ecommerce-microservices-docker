...
//    	UserResponse user = userClient.getUserById(request.getUserId());
		...
		try {
			...
			throw new UserServiceUnavailableException("Invalid! Enter Valid User");
		}
